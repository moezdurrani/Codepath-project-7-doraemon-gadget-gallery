...
const Home = () => {
  return (
    <div className="text-white text-center">
      <h1 className="text-7xl my-6">Welcome to the Crewmate Creator!</h1>
      ...
      <div className="flex flex-col items-center">
        <img src={Crewmates} alt="crewmates" width="600" height="400" />
        <img src={Ship} alt="Ship" width="600" height="400"/>
      </div>
    </div>
  )
}
